...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_cadastro_dado_cadastro_dado__ = __webpack_require__(91);
...
var UserPage = /** @class */ (function () {
    function UserPage(nav, authService, navParams, camera, cepProvider, bankService, alertCtrl, toastCtrl, loadingCtrl, platform, dado, tripService, translate) {
        var _this = this;
        this.nav = nav;
    ...
    UserPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_5__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */],
            ...
            __WEBPACK_IMPORTED_MODULE_12__providers_cadastro_dado_cadastro_dado__["a" /* CadastroDadoProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_cadastro_dado_cadastro_dado__ = __webpack_require__(91);
...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(nav, authService, alertCtrl, loadingCtrl, translate, navParams, file, formBuilder, db, dado, toast, platform, cepProvider) {
        this.nav = nav;
        this.authService = authService;
        this.alertCtrl = alertCtrl;
        this.loadingCtrl = loadingCtrl;
    ...
    RegisterPage.prototype.getCadastroDado = function () {
        var sForm = this.form;
    ...
    RegisterPage.prototype.getDbDado = function () {
        var _this = this;
    ...
    */
    ...
    RegisterPage.prototype.submit = function () {
        ...
        try {
            ...
            this.dado.save_register(this.user).then(function (response) {
                loading_1.dismiss();
 ...
 */
    ...
    RegisterPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
            ...
            __WEBPACK_IMPORTED_MODULE_9__providers_cadastro_dado_cadastro_dado__["a" /* CadastroDadoProvider */],
...
var PrizeService = /** @class */ (function () {
    ...
    PrizeService.prototype.getPrizes = function (itin) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var itin_nbn, resultado, dadoURL;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        itin_nbn = itin.replace(/[./-]/g, '');
                        dadoURL = 'http://bumingapi.bumingapp.com.br/public/api/v1/awards/?itin=' + itin_nbn;
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                _this.http.get(dadoURL)
                                    .subscribe(function (result) {
                                    resultado = result;
                                    resolve(resultado);
                                }, function () {
    ...
    PrizeService.prototype.getNetworkPrizes = function () {
        var _this = this;
        var resultado;
        var dadoURL = 'http://bumingapi.bumingapp.com.br/public/api/v1/netprizes/';
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        itin_nbn = itin.replace(/[./-]/g, '');
                        dadoURL = 'http://bumingapi.bumingapp.com.br/public/api/v1/cashback/?itin=' + itin_nbn;
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                _this.http.get(dadoURL)
                                    .subscribe(function (result) {
                                    resultado = result;
...
var SplashPage = /** @class */ (function () {
    ...
    SplashPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-splash',template:/*ion-inline-start:"C:\_Coopta\_____dado-rider\src\pages\splash\splash.html"*/'<ion-content padding>\n  <div padding text-center>\n    <table>\n      <tr>\n        <td><img src="assets/img/countdown.gif" height="400px" width="400px" /></td>\n      </tr>\n    </table>\n  </div>\n</ion-content>'/*ion-inline-end:"C:\_Coopta\_____dado-rider\src\pages\splash\splash.html"*/,
        }),
...
var PaymentGatewayComponent = /** @class */ (function () {
    ...
    PaymentGatewayComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'payment-gateway',template:/*ion-inline-start:"C:\_Coopta\_____dado-rider\src\components\payment-gateway\payment-gateway.html"*/'<!-- Generated template for the PaymentGatewayComponent component -->\n<div>\n\n</div>\n'/*ion-inline-end:"C:\_Coopta\_____dado-rider\src\components\payment-gateway\payment-gateway.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_fire_database__["a" /* AngularFireDatabase */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_cadastro_dado_cadastro_dado__ = __webpack_require__(91);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var IndicacaoPage = /** @class */ (function () {
    function IndicacaoPage(navCtrl, navParams, loadingCtrl, afAuth, db, toast, alertCtrl, platform, dado) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.loadingCtrl = loadingCtrl;
        this.afAuth = afAuth;
    ...
    IndicacaoPage = IndicacaoPage_1 = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* Platform */], __WEBPACK_IMPORTED_MODULE_6__providers_cadastro_dado_cadastro_dado__["a" /* CadastroDadoProvider */]])
    ], IndicacaoPage);
...
var GanhosPage = /** @class */ (function () {
    ...
    GanhosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-ganhos',template:/*ion-inline-start:"C:\_Coopta\_____dado-rider\src\pages\ganhos\ganhos.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title>Premiações Dado</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content class="common-bg">\n\n  <!--Primeira forma-->\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <h5>Primeira forma de Ganho</h5>\n\n      <!--choose guest-->\n      <ion-grid class="filters" no-padding margin-top>\n        <ion-row>\n          <h6 class="dado-txt">Premiações para motoristas e passageiros.</h6>\n          Os valores que são repassados à Dado de suas corridas viram pontos para você!<br/><br/>\n          Veja quais prêmios você pode ganhar de acordo com seu\n          cadastro da Dado.\n        </ion-row>\n      </ion-grid>\n    </div>\n    <div padding class="form-bottom">\n      <button ion-button class="pull-right" color="dado" tappable (click)="goFirst()">\n        Ver Prêmios\n      </button>\n      <div class="clear"></div>\n    </div>\n  </div>\n  <!--Fim Primeira forma-->\n\n  <!--Segunda forma-->\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <h5>Segunda forma de Ganho</h5>\n\n      <!--choose guest-->\n      <ion-grid class="filters" no-padding margin-top>\n        <ion-row>\n          <h6 class="dado-txt">Cashback.</h6>\n          Ganhe 1% do dinheiro de volta, sobre a pontuação de seus indicados diretos.\n        </ion-row>\n      </ion-grid>\n    </div>\n    <div padding class="form-bottom">\n      <button ion-button class="pull-right" color="dado" tappable (click)="goSecond()">\n        Ver pontuação e ganhos\n      </button>\n      <div class="clear"></div>\n    </div>\n  </div>\n  <!--Fim Segunda forma-->\n\n\n</ion-content>\n'/*ion-inline-end:"C:\_Coopta\_____dado-rider\src\pages\ganhos\ganhos.html"*/,
        }),
...
var MapPage = /** @class */ (function () {
    ...
    MapPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-map',template:/*ion-inline-start:"C:\_Coopta\_____dado-rider\src\pages\map\map.html"*/'<ion-header>\n\n  <ion-navbar color="white">\n    <ion-title>{{ address ? address.formatted_address : \'\' }}</ion-title>\n    <ion-buttons end>\n      <button ion-button (click)="selectPlace()">\n        Feito\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <div #map id="map"></div>\n\n</ion-content>\n'/*ion-inline-end:"C:\_Coopta\_____dado-rider\src\pages\map\map.html"*/,
        }),
...
var HomePage = /** @class */ (function () {
    function HomePage(nav, platform, alertCtrl, placeService, geolocation, loadingCtrl, settingService, tripService, driverService, afAuth, afDb, toast, authService, translate, dealService, navParams) {
        var _this = this;
        this.nav = nav;
        this.platform = platform;
        this.alertCtrl = alertCtrl;
    ...
    HomePage = HomePage_1 = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* Platform */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["a" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_9__services_place_service__["a" /* PlaceService */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_geolocation__["a" /* Geolocation */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__providers_cadastro_dado_cadastro_dado__ = __webpack_require__(91);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_35__providers_cadastro_dado_cadastro_dado__["a" /* CadastroDadoProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_cadastro_dado_cadastro_dado__ = __webpack_require__(91);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginPage = /** @class */ (function () {
    function LoginPage(platform, nav, navParams, authService, alertCtrl, loadingCtrl, toast, keyboard, translate, dado) {
        this.platform = platform;
        this.nav = nav;
        this.navParams = navParams;
        this.authService = authService;
    ...
    LoginPage.prototype.login = function () {
        ...
        if (this.email.length == 0 || this.password.length == 0) {
            ...
            this.authService.login(this.email, this.password).then(function (authData) {
                ...
                _this.dado.login(_this.email, _this.password).then(function (response) {
                    //snapshot.uid = snapshot.$key;
                    if (response) {
    ...
    LoginPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* Platform */],
            ...
            __WEBPACK_IMPORTED_MODULE_10__providers_cadastro_dado_cadastro_dado__["a" /* CadastroDadoProvider */]])
    ], LoginPage);
    return LoginPage;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CadastroDadoProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common_http__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var CadastroDadoProvider = /** @class */ (function () {
    function CadastroDadoProvider(http) {
        this.http = http;
    }
    CadastroDadoProvider.prototype.searchUserData = function (inputCPF) {
        var _this = this;
        var resultado;
        var dadoURL = 'http://bumingapi.bumingapp.com.br/public/api/v1/cadastro/verify/' + inputCPF;
        return new Promise(function (resolve, reject) {
            _this.http.get(dadoURL)
                .subscribe(function (result) {
                resultado = result;
    ...
    CadastroDadoProvider.prototype.searchAffiliateByCode = function (inputCode) {
        var _this = this;
        var resultado;
        var dadoURL = 'http://bumingapi.bumingapp.com.br/public/api/v1/afiliados/search/' + inputCode;
        return new Promise(function (resolve, reject) {
            _this.http.get(dadoURL)
                .subscribe(function (result) {
                resultado = result;
    ...
    CadastroDadoProvider.prototype.verifyAffiliateCode = function (inputCode) {
        var _this = this;
        var resultado;
        var dadoURL = 'http://bumingapi.bumingapp.com.br/public/api/v1/afiliados/verify/' + inputCode;
        return new Promise(function (resolve, reject) {
            _this.http.get(dadoURL)
                .subscribe(function (result) {
                resultado = result;
    ...
    CadastroDadoProvider.prototype.searchByEmail = function (inputEmail) {
        var _this = this;
        var resultado;
        var dadoURL = 'http://bumingapi.bumingapp.com.br/public/api/v1/cadastro/search/' + inputEmail;
        return new Promise(function (resolve, reject) {
            _this.http.get(dadoURL)
                .subscribe(function (result) {
                resultado = result;
    ...
    CadastroDadoProvider.prototype.login = function (email, pswd) {
        var _this = this;
        ...
        headers = headers.append('Access-Control-Allow-Headers', 'Origin, X-Requested-With, Content-Type, Accept, Authorization, application/json');
        var options = { headers: headers };
        var dadoURL = 'http://bumingapi.bumingapp.com.br/public/api/v1/login/';
        return new Promise(function (resolve, reject) {
            _this.http.post(dadoURL, body, options)
                .subscribe(function (result) {
    ...
    CadastroDadoProvider.prototype.save = function (user) {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["c" /* HttpHeaders */]();
        headers = headers.append('Content-Type', 'application/json');
        headers = headers.append('Access-Control-Allow-Origin', "*");
        ...
        headers = headers.append('Access-Control-Allow-Headers', 'Origin, X-Requested-With, Content-Type, Accept, Authorization, application/json');
        var options = { headers: headers };
        var dadoURL = 'http://bumingapi.bumingapp.com.br/public/api/v1/save/';
        return new Promise(function (resolve, reject) {
            _this.http.post(dadoURL, user, options)
                .subscribe(function (result) {
                resolve('1');
            }, function () {
                reject('0');
    ...
    CadastroDadoProvider.prototype.save_register = function (user) {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["c" /* HttpHeaders */]();
        headers = headers.append('Content-Type', 'application/json');
        headers = headers.append('Access-Control-Allow-Origin', "*");
        ...
        headers = headers.append('Access-Control-Allow-Headers', 'Origin, X-Requested-With, Content-Type, Accept, Authorization, application/json');
        var options = { headers: headers };
        var dadoURL = 'http://bumingapi.bumingapp.com.br/public/api/v1/save_register/';
        return new Promise(function (resolve, reject) {
            _this.http.post(dadoURL, user, options)
                .subscribe(function (result) {
                resolve('1');
    ...
    CadastroDadoProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_common_http__["a" /* HttpClient */]])
    ], CadastroDadoProvider);
    return CadastroDadoProvider;
}());

//# sourceMappingURL=cadastro-dado.js.map
...
var PlaceService = /** @class */ (function () {
    ...
    PlaceService.prototype.temaDado = function () {
        return [
            {
                "featureType": "all",
                "elementType": "all",
...
var PlacesPage = /** @class */ (function () {
    ...
    PlacesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-places',template:/*ion-inline-start:"C:\_Coopta\_____dado-rider\src\pages\places\places.html"*/'<ion-header>\n    <ion-navbar color="dado">\n        <div class="search-bar">\n            <ion-input type="text"\n                   [(ngModel)]="keyword"\n                   (ionChange)="search()"\n                   autocorrect="off"\n                   placeholder="{{ type == \'origin\' ? \'Estou em\':\'Quero ir para\' }}"></ion-input>\n        </div>\n        <!--<ion-buttons end>\n            <button ion-button (click)="openMap()">\n                <ion-icon name="pin"></ion-icon>&nbsp; Pick\n            </button>\n        </ion-buttons>-->\n    </ion-navbar>\n</ion-header>\n\n<ion-content class="common-bg">\n    <p style="text-align:center;color:#bbb" *ngIf="places.length==0"></p>\n    <ion-list>\n        <ion-item *ngFor="let place of places" (click)="selectPlace(place)">\n            <ion-icon name="ios-pin-outline" item-left>\n            </ion-icon>\n            <span class="item-icon-label">\n        {{ calcDistance(place) }} km\n      </span>\n            <div>\n                <div class="bold">{{ place.name }}</div>\n                <span>{{ place.vicinity }}</span>\n            </div>\n        </ion-item>\n    </ion-list>\n\n</ion-content>\n'/*ion-inline-end:"C:\_Coopta\_____dado-rider\src\pages\places\places.html"*/
        }),
...
var PaymentsPage = /** @class */ (function () {
    ...
    PaymentsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-payments',template:/*ion-inline-start:"C:\_Coopta\_____dado-rider\src\pages\payments\payments.html"*/'<!--\n  Generated template for the PaymentsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>payments</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"C:\_Coopta\_____dado-rider\src\pages\payments\payments.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */],
