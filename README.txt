#================================================
# App: Dado - Passageiro: Mobilidade Urbana app do Passageiro
...
# APENAS INSTALAR
adb.exe install -r C:\_Coopta\dado-rider\platforms\android\app\build\outputs\apk\debug\app-debug.apk
